...
<body>
  ...
  <div class="content-container">
        <div class="text-content">
            <h4>Veterinary Excellence</h4>
            <h1>Streamlining clinic operations</h1>
            <p>VetEtec revolutionizes veterinary clinic management with its comprehensive software solution. Located in Ribeirão Preto, we empower clinics to operate more efficiently through features like appointment scheduling, inventory management, and enhanced client communication. Our platform not only simplifies daily tasks but also enhances the overall client experience, allowing veterinary professionals to focus more on what they love: taking care of animals.</p>
            <button class="contact-button">Get in Touch</button>
        </div>
        <div class="image-content">
            <img src="https://via.placeholder.com/400" alt="Dog's face" />
        </div>
    </div>
